...
struct ETSurfaceEvents {
    ...
    virtual void ET_onSurfaceTouch(const Vec2i& pos) {}
...
void LogDebug(const char* msg, const ArgsT& ... args) {
    ET_SendEventToAll(&ETLogger::ET_logMessage, LogLevel::Debug, StringFormat(msg, args ... ));
}

template<typename ... ArgsT>
void LogInfo(const char* msg, const ArgsT& ... args) {
    ET_SendEventToAll(&ETLogger::ET_logMessage, LogLevel::Info, StringFormat(msg, args ... ));
}

template<typename ... ArgsT>
void LogWarning(const char* msg, const ArgsT& ... args) {
    ET_SendEventToAll(&ETLogger::ET_logMessage, LogLevel::Warning, StringFormat(msg, args ... ));
}

template<typename ... ArgsT>
void LogError(const char* msg, const ArgsT& ... args) {
    ET_SendEventToAll(&ETLogger::ET_logMessage, LogLevel::Error, StringFormat(msg, args ... ));
}

template<typename ... ArgsT>
void LogFatal(const char* msg, const ArgsT& ... args) {
    ET_SendEventToAll(&ETLogger::ET_logMessage, LogLevel::Fatal, StringFormat(msg, args ... ));
}
